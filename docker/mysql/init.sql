...
INSERT INTO info (agent_id,site_name,agent_name,logo,explanation,type,size,area,amounts,category,url,email) VALUES
    (1,'doda','パーソルキャリア株式会社','top_doda_ikon.png','aaaaaaaaaaaaaaaaaaaaaaaa','総合','大手','全国','100万','','https://aaaa','aaa@gmail.com'),
    (2,'リクナビ就活エージェント','リクルート株式会社','top_rikunabi_ikon.png','bbbbbbbbbbbbbbbbbbbb','総合','中小','東京','200万','','https://bbbb','bbb@gmail.com'),
    (3,'doda','パーソルキャリア株式会社','top_doda_ikon.png','cccccccccccccccccccc','総合','中小','全国','300万','','https://cccc','ccc@gmail.com'),
    (4,'リクナビ就活エージェント','リクルート株式会社','top_rikunabi_ikon.png','dddddddddddddddddddd','総合','大手','東京','400万','','https://dddd','ddd@gmail.com'),
    (5,'doda','パーソルキャリア株式会社','top_doda_ikon.png','eeeeeeeeeeeeeeeeeeeee','特化','','東京','500万','女性','https://eeee','eee@gmail.com'),
    (6,'リクナビ就活エージェント','リクルート株式会社','top_rikunabi_ikon.png','fffffffffffffffffffff','特化','','全国','600万','IT','https://ffff','fff@gmail.com'),
    (7,'doda','パーソルキャリア株式会社','top_doda_ikon.png','ggggggggggggggggggggg','特化','','大阪','700万','税理士','https://gggg','ggg@gmail.com'),
    (8,'リクナビ就活エージェント','リクルート株式会社','top_rikunabi_ikon.png','hhhhhhhhhhhhhhhhhhhh','特化','','全国','800万','外資系','https://hhhh','hhh@gmail.com');
