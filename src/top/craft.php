...
<body class="body_2">
    <main>
        ...
        <div class="container">
            <!-- CRAFTとの出会いであなたの就活を -->
            <section class="CRAFTexplanation">
                <div class="CRAFTexplanationHead">
                    CRAFTとの出会いであなたの就活を
                </div>
            ...
            <section class="CRAFTcontent">
                <!-- 従来の申し込みの仕方 -->
                <div class="CRAFTlist1">
                    <div class="CRAFTlistTitle">
                        <h2 class="CRAFTlistTitleText">
                            従来の申し込みの仕方
                        </h2>
                    </div>
                    ...
                    <div class="CRAFTcircle">
                        <div class="CRAFTcircleList">
                            <div class="circleCRAFT">
                                <figure><img class="CRAFTcircle-img" src="../assets/img/aboutCRAFT_logo.png" alt="" width="200px" style="object-fit: contain;"></figure>
                            </div>
                        </div>
